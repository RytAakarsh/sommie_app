...
// import '../presentation/screens/auth/ai_terms_screen.dart';
// import '../presentation/screens/auth/auth_flow_screen.dart';
// import '../presentation/screens/auth/forgot_password/forgot_password_email_screen.dart';
// import '../presentation/screens/auth/forgot_password/forgot_password_otp_screen.dart';
// import '../presentation/screens/auth/forgot_password/forgot_password_reset_screen.dart';
// import '../presentation/screens/freemium/freemium_chat_screen.dart';
// import '../presentation/screens/freemium/free_edit_profile_screen.dart';
// import '../presentation/screens/freemium/free_cellar_screen.dart';
// import '../presentation/screens/freemium/free_add_wine_screen.dart';
...
//   static const String aiTerms = '/ai-terms';
...
//       // Auth Flow (NEW)
//       case authFlow:
//         return MaterialPageRoute(builder: (_) => const AuthFlowScreen());
...
//       case aiTerms:
//         return MaterialPageRoute(builder: (_) => const AITermsScreen());
...
import '../presentation/screens/freemium/free_preview_wine_screen.dart';
import '../presentation/screens/freemium/free_confirm_wine_screen.dart';
import '../presentation/screens/freemium/free_choose_avatar_screen.dart';
...
class AppRoutes {
  ...
  static const String freePreviewWine = '/free-preview-wine';
  static const String freeConfirmWine = '/free-confirm-wine';
  static const String freeChooseAvatar = '/free-choose-avatar';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case forgotReset:
        return MaterialPageRoute(builder: (_) => const ForgotPasswordResetScreen());
      ...
      case freeEditProfile:
  return MaterialPageRoute(
    builder: (context) => const FreeEditProfileScreen(),
  );
      case freeCellar:
        return MaterialPageRoute(builder: (_) => FreeCellarScreen(
          setView: (view) {
            Navigator.of(_).pop();
          },
        ));
      case freeAddWine:
        return MaterialPageRoute(builder: (_) => FreeAddWineScreen(
          setView: (view) {
            Navigator.of(_).pop();
          },
        ));
      case freePreviewWine:
        return MaterialPageRoute(builder: (_) => FreePreviewWineScreen(
          setView: (view) {
            Navigator.of(_).pop();
          },
        ));
      case freeConfirmWine:
        return MaterialPageRoute(builder: (_) => FreeConfirmWineScreen(
          setView: (view) {
            Navigator.of(_).pop();
          },
        ));
  case freeChooseAvatar:
    return MaterialPageRoute(
      builder: (context) => FreeChooseAvatarScreen(
        onAvatarSelected: () {
      ...
      default:
        // Return splash screen as fallback
        return MaterialPageRoute(builder: (_) => const SplashScreen());
    }
  }
}