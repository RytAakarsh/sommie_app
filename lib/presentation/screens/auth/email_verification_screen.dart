...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  // ✅ Helper function to parse user response (Clean Architecture)
  UserModel _parseUserResponse(Map<String, dynamic> data) {
    final token = data['token'] as String;
    final userMap = data['user'] as Map<String, dynamic>;
    
    // Convert JSON to UserModel and add token
    return UserModel.fromJson(userMap).copyWith(token: token);
  }
  ...
  Future<void> _verifyOTP() async {
    ...
    try {
      ...
      print('🔄 Verifying OTP at: ${ApiEndpoints.verifyOtp}');
      print('📝 Email: ${flow.email}');
      print('📝 OTP: $otpCode');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        // ✅ FIXED: Convert API response to UserModel
        final user = _parseUserResponse(data);
